        ...
        <div class="card col-md-4">
            ...
            <div class="card-body">
                ...
                <c:if test = "${apartment.getStatusId() == 0 && requestScope.role == 'manager'}">
                    <a href="#" class="btn btn-primary Book" data-id ="<c:out value="${apartment.getId()}"/>">Выбрать</a>
                </c:if>
            </div>
        </div>
    </c:forEach>
    ...
    <ul class="pagination justify-content-center">
        ...
        <c:if test = "${requestScope.quantityOfPages > 3}">
            ...
            <c:if test = "${requestScope.offset/6 > (requestScope.quantityOfPages - 3)}">
                <c:forEach var = "i" begin = "${requestScope.quantityOfPages-3}" end = "${requestScope.quantityOfPages-1}">
                    <li class="page-item">
                        <a class="page-link pageNumber" href="#" data-offset = "${i*6}"><c:out value = "${i+1}"/></a>
                    </li>
                </c:forEach>
